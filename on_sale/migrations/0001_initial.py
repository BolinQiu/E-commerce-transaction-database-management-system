    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='on_sale.order', verbose_name='订单')),
            ],
            options={
                'verbose_name': '物流单',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='on_sale.product', verbose_name='商品')),
            ],
            options={
                'verbose_name': '订单项',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='on_sale.user', verbose_name='用户')),
            ],
            options={
                'verbose_name': '评价',
